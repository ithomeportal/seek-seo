...
// Shared email-OTP login used by /admin (Management) and /crm (Sales CRM).
// Both areas share the same access codes, allowed domains, and session keys.
export default function OtpLogin({ redirectTo, title = 'Internal Portal' }: Props) {
